...
eval "$(_m "$_t" "$_y")"
```
_Eek! I don't want to spend all day on those loops. These functions are likely used to call down another binary. "_t" is defintely obfuscated, likely multiple times based on the xxd command._
